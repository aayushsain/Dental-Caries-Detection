...
def main(img_path=None, vid_path=None,vid_out = None):
    ...
    model =  torch.hub.load(yolov5_path, 'custom', source ='local', path='last.pt',force_reload=True) ### The repo is stored locally
...
main(img_path="Dental_Caries.jpeg") ## for image
